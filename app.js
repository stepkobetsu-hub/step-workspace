(function(){
  ...
  function renderCategories(){
    ...
    groups.forEach(({category,apps},index)=>{
      const navItem=document.createElement('div');navItem.className=`category-nav-item ${category.className}`;navItem.dataset.categoryId=category.id;navItem.dataset.search=Core.normalize([category.label,...apps.map(app=>app.name)].join(' '));navItem.draggable=state.organizing;
